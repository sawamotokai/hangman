  ...
  render() {
    ...
    return (
      <div className='Hangman'>
        ...
        <p className="Hangman-wrongGuesses">Number wrong: {this.state.nWrong}</p>
        <p className='Hangman-word'>{!gameOver?this.guessedWord():this.state.answer}</p>
        <p className='Hangman-btns'>{gameState}</p>
        <button className="Hangman-restart" id="restart" onClick={this.handleRestart}>Restart!</button> 
